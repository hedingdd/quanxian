    ...
    <div class="cenbox">
      <ul>
        ...
        <li v-if="isLogin">
          ...
          <el-select v-model="statLogin.Loginarea" style="width: 250px;">
            <el-option
              style="width: 250px;"
...
export default {
  ...
  methods: {
    ...
    loseFocus(index) {
      switch (index) {
        case 1:
          this.isreg.isname = this.statLogin.Loginname == "" ? true : false;
          break;
        case 2:
        ...
        case 4:
          this.isreg.isdate =
            this.statLogin.Logindate == "" || this.statLogin.Logindate == null
              ? true
              : false;
          break;
        case 5:
          this.regPhone(this.statLogin.Loginmobile);
          this.isreg.ismobile = this.statLogin.Loginmobile == "" ? true : false;
          break;
        case 6:
          this.isreg.iscode = this.statLogin.Logincode == "" ? true : false;
          break;
      }
    },
    // 切换登录注册
